model:          pillar
                ...
                skin changed 02.2004 using the Egyptian Texture Pack by sock, http://www.planetquake.com/simland
...
description:    unzip the tris.md2 and skin.jpg files to cube/packages/models/ using 'full path information' (how is this
                ...
                hint: best used to support a lowered ceiling...
...
credits:        id-software (tris.md2 format)
...
notes:          modified/updated by Nieb on 2023-01-10
